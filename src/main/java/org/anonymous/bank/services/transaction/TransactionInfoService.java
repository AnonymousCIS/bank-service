...
public class TransactionInfoService {
    ...
    public ListData<Transaction> getList(TransactionSearch search) {
        ...
        Long transactionLimitMin = Objects.requireNonNullElse(search.getPayAmountMin(), 0L) > 0L ? search.getPayAmountMin() : 0L;
...
//        }
     ...
     * @return
     */
    public ListData<Transaction> getMyList(TransactionSearch search) {
